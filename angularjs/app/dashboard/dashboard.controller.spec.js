...
describe('Controller: Dashboard', function () {
  ...
  beforeEach(inject(function ($rootScope, _$controller_, _$q_, _userService_, _githubService_) {
    $scope = $rootScope.$new();
  ...
  it('should set user data from userService', function () {
  ...
  it('should set repo data from githubService', function () {
    var vm = $controller('Dashboard', {
      $scope: $scope,
      userService: userService,
      githubService: githubService
    ...
    expect(vm.starredData).to.deep.equal(starred);
  });
});
