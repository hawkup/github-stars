...
describe('Controller: Dashboard', function () {
  ...
  it('should set vm.userData when ui-router resolve', function () {
    ...
    expect(vm.userData).to.deep.equal(userData);
  });

  it('should set vm.starredData when ui-router resolve', function () {
    var vm = $controller('Dashboard', {
      $scope: $scope,
      userData: userData,
      starredData: starredData
    ...
    expect(vm.starredData).to.deep.equal(starredData);
  });
});
