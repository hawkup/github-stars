...
describe('Component: topnav', function () {
  ...
  beforeEach(inject(function ($rootScope, _$componentController_, _$compile_, _userService_) {
    $scope = $rootScope.$new();
    $compile = _$compile_;
  ...
  it('should call onLogout when call logout', function () {
    var onLogout = sandbox.spy();
